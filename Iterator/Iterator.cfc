<!--- 
 ...
 --->
<cfcomponent displayname="Iterator" output="false" hint="I am a Iterator object.  I convert a query to an array of records and the manage the travesal of array elements.">

	<cffunction name="init" access="public" output="false" returntype="com.fancybread.util.list.Iterator">
	...
	<cffunction name="next" access="public" output="false" returntype="struct">
		<cfset variables.recordIndex = currentIndex() + 1 />
		<cfreturn variables.records[currentIndex()] />
	</cffunction>
	...
	<cffunction name="previous" access="public" output="false" returntype="struct">
		<cfset variables.recordIndex = currentIndex() - 1 />
		<cfreturn variables.records[currentIndex()] />
	</cffunction>
